...
Save it in the folder [dataset] in the structure `dataset/gtFine` and `dataset/leftImg8bit`
...
DATA_FLAGS="--data_dir '/kaggle/input/dataset/dataset' --augment False"
```
...
Once you have a path to your model, you can evaluate IoU, Dice score,...

```
python scripts/evaluate.py --model_path /path/to/model.pt $MODEL_FLAGS $DIFFUSION_FLAGS
```
